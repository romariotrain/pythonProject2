    ...
    for info in repeatable_person:
      ...
      if info == '':
        for repeatable_person_ in repeatable_contacts:
          if repeatable_person_[0] == repeatable_person[0] and repeatable_person_[1] == repeatable_person[1] and repeatable_person != repeatable_person_ :
...
def change_names(contacts_list, repeatable_contacts):
  for contact in contacts_list:
    for repeatable_person in repeatable_contacts:
      if contact[0] == repeatable_person[0] and contact[1] == repeatable_person[1] and contact != repeatable_person:
